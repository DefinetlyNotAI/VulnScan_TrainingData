...
You will find a bunch of Models and different types, here is a basic documentation overview, taken from [here](https://github.com/DefinetlyNotAI/Logicytics/blob/main/CODE/VulnScan/README.md?plain=1)
